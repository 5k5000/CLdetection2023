...
class RandomFlip(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if flip_dir is None:
            ...
            # add by wuqian
            channel_num =len(results["keypoints"][0])
            flip_indices_num = len(results['flip_indices'])
            if channel_num < flip_indices_num:
                results["flip_indices"] = results['flip_indices'][:channel_num]
